...
impl Gpu {
    pub fn gp0_nop(&mut self, _params: ArrayVec<Command, 16>) {
        // Do nothing
    }

    pub fn gp0_clear_cache(&mut self, _params: ArrayVec<Command, 16>) {
        // unimplemented
    }

    pub fn gp0_draw_mode(&mut self, params: ArrayVec<Command, 16>) {
    ...
    pub fn gp0_drawing_area_top_left(&mut self, params: ArrayVec<Command, 16>) {
    ...
    pub fn gp0_drawing_area_bottom_right(&mut self, params: ArrayVec<Command, 16>) {
    ...
    pub fn gp0_drawing_area_offset(&mut self, params: ArrayVec<Command, 16>) {
    ...
    pub fn gp0_texture_window(&mut self, params: ArrayVec<Command, 16>) {
    ...
    pub fn gp0_mask_bit_setting(&mut self, params: ArrayVec<Command, 16>) {
        self.stat
    ...
    pub fn gp0_image_store(&mut self, params: ArrayVec<Command, 16>) {
    ...
    pub fn gp0_image_load(&mut self, params: ArrayVec<Command, 16>) {
        let (x, y) = parse_xy(params[1].0);
        let (width, height) = parse_xy(params[2].0);
    ...
    // DRAW COMMANDS
    pub fn gp0_quick_rect_fill(&mut self, params: ArrayVec<Command, 16>) {
    ...
    pub fn gp0_vram_to_vram_blit(&mut self, params: ArrayVec<Command, 16>) {
    ...
    pub fn gp0_quad_mono_opaque(&mut self, params: ArrayVec<Command, 16>) {
        let color = Color::new_8bit(params[0].0).to_5bit();
    ...
    pub fn gp0_quad_shaded_opaque(&mut self, params: ArrayVec<Command, 16>) {
        let (x0, y0) = parse_xy(params[1].0);
    ...
    pub fn gp0_triangle_shaded_opaque(&mut self, params: ArrayVec<Command, 16>) {
        let (x0, y0) = parse_xy(params[1].0);
        let (x1, y1) = parse_xy(params[3].0);
        let (x2, y2) = parse_xy(params[5].0);
    ...
    pub fn gp0_quad_texture_blend_opaque(&mut self, params: ArrayVec<Command, 16>) {
        let (x0, y0) = parse_xy(params[1].0);
        let (x1, y1) = parse_xy(params[3].0);
        let (x2, y2) = parse_xy(params[5].0);
        let (x3, y3) = parse_xy(params[7].0);
    ...
    pub fn gp0_draw_1x1_rectangle(&mut self, params: ArrayVec<Command, 16>) {
        let color = Color::new_8bit(params[0].0).to_5bit();
        let (x, y) = parse_xy(params[1].0);
        self.renderer
