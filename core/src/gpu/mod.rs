        ...
        let (color, cmd): (bool, PolyLineFn) = match command.opcode() {
            ...
            _ => {
                let (len, cmd): (usize, CommandFn) = match command.opcode() {
                    ...
                    0x20 => (4, Gpu::gp0_triangle_mono::<false>),
                    0x22 => (4, Gpu::gp0_triangle_mono::<true>),
                    ...
                    0x28 => (5, Gpu::gp0_quad_mono::<false>),
                    0x2A => (5, Gpu::gp0_quad_mono::<true>),
                    ...
                    0x30 => (6, Gpu::gp0_triangle_shaded::<false>),
                    0x32 => (6, Gpu::gp0_triangle_shaded::<true>),
                    0x38 => (8, Gpu::gp0_quad_shaded::<false>),
                    0x3A => (8, Gpu::gp0_quad_shaded::<true>),
