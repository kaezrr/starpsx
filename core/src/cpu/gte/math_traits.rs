...
impl MultiplyAccumVector {
    ...
    pub fn add_vec<T: AsU32, const FB: usize>(&mut self, v: Vector3<T, FB>) {
        self.raw1 += v.x.0.as_u32() as i64;
        self.raw2 += v.y.0.as_u32() as i64;
        self.raw3 += v.z.0.as_u32() as i64;
    }

    /// Multiply a matrix and a vector and add them to the accumulator
    pub fn mul_mat_vec<T, const FB: usize>(&mut self, m: Matrix3, v: Vector3<T, FB>) {
